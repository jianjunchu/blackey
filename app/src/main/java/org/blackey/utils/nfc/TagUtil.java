...
/**
 * 这是一个用于  NFC 芯片（13.56Mhz， 14443A ）的  Android SDK. 用来方便对   NFC 芯片进行读、写、锁定、认证、更换秘钥等操作.
 * 目前该SDK 支持的芯片类型包括  FJ8018，  NXP203, NXP216 等.
 * 如果您在使用中有问题，请和我们联系。
 * 技术支持邮箱   support@nfcsolution.cnaddress
 *
 * 如需购买本 SDK 支持的NFC 芯片/标签/卡， 请到：
