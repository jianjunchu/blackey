...
public class MyAccountListItemViewModel extends MultiItemViewModel<MyAccountViewModel> {
    ...
    public MyAccountListItemViewModel(@NonNull MyAccountViewModel viewModel) {
        super(viewModel);
    }

    public MyAccountListItemViewModel(@NonNull MyAccountViewModel viewModel, UserPaymentMode entity) {
        super(viewModel);
