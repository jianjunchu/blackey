...
import org.blackey.databinding.FragmentWalletSendBtcSuccessBinding;
...
public class SendBtcSuccessWizardFragment extends SendWizardFragment<FragmentWalletSendBtcSuccessBinding,SendBtcSuccessWizardViewModel> {
    ...
    public int initContentView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return R.layout.fragment_wallet_send_btc_success;
    }
