...
import org.blackey.databinding.FragmentSellerOrderInfoBinding;
...
public class SellerOrderInfoFragment extends BlackeyBaseFragment<FragmentSellerOrderInfoBinding, SellerOrderInfoViewModel> {
    ...
    public int initContentView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return R.layout.fragment_seller_order_info;
    }
